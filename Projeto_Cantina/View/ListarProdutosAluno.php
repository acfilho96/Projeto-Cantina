...
?>
  ...
  <div class="col-sm-3 sidenav">                    
                    ...
                    <p><a href="./View/Logout.php"><span class="glyphicon glyphicon-log-in"></span> Sair </a></p>                                            
                    <br>
                    <br />
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="LISTARPRODUTOSALUNO">Produtos</a></li>
...
<div class="container-fluid bg-3">
  ...
  border-style: outset;
  border-radius: 0px; 
  border-color: rgb(155, 155, 155);"><b>Produtos</b></h2>
    ...
    <tbody>
      <?php for($i=0;$i<count($listarComidas);$i++){ ?>
        <?php if ($listarComidas[$i]->getTipo()==1){ ?>
           ...
           <td>
           <form method="post" action="ADDITEMCARRINHO" onSubmit="return confirma();">
